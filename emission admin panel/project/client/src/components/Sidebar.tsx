import { Package, MessageSquare, ShoppingCart, LogOut, LayoutDashboard, Settings as SettingsIcon, FileText, Zap, Truck, Image as ImageIcon, LayoutGrid, Palette, Tag, Mail, Search } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: '/seo', icon: Search, label: 'SEO & Branding' },
