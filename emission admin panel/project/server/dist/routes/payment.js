...
router.post('/verify-payment', async (req, res) => {
    try {
        const { razorpay_order_id, razorpay_payment_id, razorpay_signature, orderDetails, customerId, } = req.body;
        ...
        if (existingOrder) {
            order = await prisma.order.update({
                ...
                data: {
                    ...
                    customerPhone: orderDetails?.customerPhone || existingOrder.customerPhone,
                }
            });
        }
        else {
