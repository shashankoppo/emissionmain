...
router.post('/', authMiddleware, async (req, res) => {
    try {
        const { name, slug, category, subcategory, description, shortDescription, price, wholesalePrice, retailPrice, images, features, specifications, inStock, moq, availableSizes, availableColors, allowsEmbroidery, gstPercentage, shippingIncluded } = req.body;
        // Validation
